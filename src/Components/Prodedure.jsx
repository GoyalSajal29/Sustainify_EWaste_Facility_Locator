...
import Logo1 from "../assets/logo_final.png"
    ...
    <Wrapper>
      <div className=" flex flex-col  justify-center items-center mt-[20vh] relative">
        ...
        <div className="flex flex-col  gap-5 md:flex-row  w-full justify-between items-center  relative ">
          ...
          <div className="z-10 shadow-3xl bg-white w-full md:w-[20vw] h-fit md:p-2 p-4 flex justify-center items-center rounded-xl font-montserrat font-bold">
